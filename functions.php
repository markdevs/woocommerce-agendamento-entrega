...
function mostrar_campo_extra_apos_form_variacao () {
	...
	_e( "<div class='visit' style='margin-bottom: 4px;display:flex;justify-content: flex-start; align-items: center;'><div><label class='title is-6' style='font-weight: 700'>Data de Visita:</label></div>", "add_extra_fields");
	?>
	<input style="width: 313.617px;height:36px;margin-left: 27px;" type="text" name="add_delivery_date" class="add_delivery_date input" placeholder="Agende uma data">
	<script>
